...
function About() {
    ...
    <p>when not juggling visual studio windows, i can usually be found adventuring with friends playing tabletop games, dabbling in embroidery and crochet or reading on the beach. i'm fond of pop culture, art, aabria iyengar and my cat <button onClick={() => setShowScoob(true)}>scooby-doo</button>. </p>
    { showFaves ? 
    <p>
